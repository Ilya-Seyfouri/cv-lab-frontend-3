...
import heroImage from "../../../images/the_most_demanded_graduate_skills_in_the_uk_2026.png"; // Replace with your actual image path
  ...
  sections: [
    {
      ...
      content: [
        ...
        "This means that for many graduate schemes, hundreds of students are competing for a single position. In this environment, being 'qualified' is no longer enough and you need to be clearly relevant."
      ],
      source: {
    ...
    },
    {
      ...
      content: [
        ...
        "CVLab allows users to upload their CV once and automatically tailor it to specific job descriptions. Instead of guessing what employers want, your CV highlights the exact skills and experience each role asks for whether that comes from university projects, internships, part-time work, or volunteering.",
...
export default function MostDemandedGraduateSkills2026() {
        ...
        <div className="flex gap-12">
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 w-64">
              ...
              >
                <h3 className="mb-4 text-sm font-semibold text-cyan-300">Contents</h3>
          ...
          <main className="min-w-0 flex-1">
            ...
            >
              ...
              <div className="mb-8 overflow-hidden rounded-2xl border border-white/10">
                <Image
                  src={heroImage}
                  alt="Most Demanded Graduate Skills 2026"
                ...
                >
                  ...
                  <div className="space-y-4">
                    {section.content.map((paragraph, pIndex) => (
                      <p key={pIndex} className="text-base text-white/60 md:text-lg leading-relaxed">
                        {paragraph}
                      </p>
                    ))}
              ...
              >
                ...
                <div className="space-y-4">
                  {blogContent.conclusion.content.map((paragraph, index) => (
                    <p key={index} className="text-base text-white/60 md:text-lg leading-relaxed">
                      {paragraph}
                    </p>
                  ))}
                </div>
